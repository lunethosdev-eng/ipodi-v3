...
const FontWeight _kFontWeight = FontWeight.bold;
        ...
        return Padding(
          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              color: _kSeparatorColor.withValues(
...
class CustomSlidingSegmentedControl<T extends Object> extends StatefulWidget {
...
class _RenderSegmentedControl<T extends Object> extends RenderBox
  ...
  double getListSum(List<double> doubleList) {
    double result = 0.0;
    for (final value in doubleList) {
      result += value;
    }
    return result;
  }
  ...
  List<double> _getChildWidths(BoxConstraints constraints) {
    ...
    final double totalWidth = getListSum(segmentWidths);
  ...
  Size _computeOverallSize(BoxConstraints constraints) {
    ...
    return constraints.constrain(
      Size(
        getListSum(_getChildWidths(constraints)) + totalSeparatorWidth,
        maxChildHeight,
      ),
    );
  }
